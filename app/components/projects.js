            ...
            project
              ...
              .map((project, key) => (
                <div className="col-lg-4 col-sm-6 mb-4 section-card" key={key}>
                  <div
                    className="ms-1 me-1 shadow card bg-secondary portfolio-item shadow-lg"
                    height={500}
                  >
                    <a
                      className="p-3"
                      onClick={() => {
                        setInfoProject(project), setModalShow(true);
                      }}
                    >
                      <div
                        type="button"
                        className="portfolio-item text-center"
                        id="item"
                      >
                        <picture>
                          <img
                            className="responsive-img-project"
                            src={project.img}
                            height={230}
                            width="auto"
                            alt={project.name}
                    ...
                    <div className="mt-2 mb-2 text-light text-center">
                      {project.nombre}
                    </div>
                  </div>
                </div>
